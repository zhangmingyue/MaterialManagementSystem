...
<% 
String href = "managerinfo!pagedQuery.action";
String target="";
%>
<head>
...
<!-- 
	...
	function add(){
		window.location.href = "managerinfo!addQuery.action";
	}
	function remov(){
		...
		document.listForm.action ="managerinfo!remove.action";
	...
	function query(){
		...
		window.location.href ="managerinfo!pagedQuery.action?condition.store="+type;
	}
...
<div class="title_div">
    <div class="title_text">保管员信息</div>
...
<form name="listForm" action="" method="post">
	...
	<td width="15%" align="center">保管员</td>
