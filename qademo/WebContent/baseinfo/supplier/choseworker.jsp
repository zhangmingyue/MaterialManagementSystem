...
<!-- 
	...
	function chose(){
		...
		document.listForm.action ="supinfo!addGoodsInfoChoose.action";
		document.listForm.submit();
...
<body >
<div class="gbg">
<form name="listForm" action="supinfo!addGoodsInfoQuery.action" method="post">
<div class="title_div_sq">
	...
	<s:if test="isempty">
		<td>
			<s:select id="cl_id" list="codelist" headerKey="" headerValue="请选择"  name="cl_id" onchange="setclname();"
				   value="cl_id"  listKey="id" listValue="name"  style="width:120px;"  cssStyle="width:180px;" ></s:select>
		</td>
